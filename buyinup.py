...
def fetch_high_volume_stocks():
  """
  爬取 Yahoo 股市的「成交值排行」(資金流向最集中的主流股)，
  並過濾出符合近 10 日法人淨買超的籌碼強勢股。
  """
  url = "https://tw.stock.yahoo.com/rank/turnover" # 修正為官方真實存在的「成交值排行」
  headers = {
  ...
  try:
    ...
    for link in links:
      ...
      if match:
        ...
        # 抓到 10 檔符合「10日法人買超」的股票就停，避免訊息太長
        if len(stocks) >= 10:
          break
